...
export const NEWS_STORIES: NewsCardItem[] = [
  {
    id: "marine-conservation-results",
    ...
    excerpt:
      "Our coastal conservation program is making a real difference, with healthier marine ecosystems and increased biodiversity in key regions.",
    image: "/images/news-4.jpg",
    tags: ["#Sustainability", "#Resilience", "#Community"],
    href: "#marine-conservation-results",
  },
  {
    id: "strengthening-local-governance",
    category: "PEACE & GOVERNANCE",
    categoryId: "peace-governance",
    badgeBg: "#e6f1f8",
    badgeColor: "#17537b",
    date: "Aug 15, 2025",
    title: "Strengthening Local Governance Through Community Dialogue",
    excerpt:
      "PCSDF facilitated a series of community dialogues to strengthen local governance and promote inclusive decision-making at the grassroots level.",
    image: "/images/news-2.jpg",
    tags: ["#Peacebuilding", "#Community"],
    href: "#strengthening-local-governance",
  },
  {
    id: "rural-clean-energy-solutions",
    ...
    excerpt:
      "New solar systems are bringing clean, affordable energy to remote villages, improving livelihoods and reducing carbon emissions.",
    image: "/images/renewable.jpg",
    tags: ["#Sustainability", "#ClimateAction", "#SDGs"],
    href: "#rural-clean-energy-solutions",
  },
  {
    id: "climate-smart-agriculture-training",
    category: "LIVELIHOODS",
    categoryId: "livelihoods",
    badgeBg: "#fbf3e0",
    badgeColor: "#8b630e",
    date: "Aug 05, 2025",
    title: "Climate-Smart Agriculture Training for Farmers",
    excerpt:
      "Farmers in the dry zone received training on climate-smart agriculture techniques to improve food security and resilience.",
    image: "/images/knowledge/agriculture.jpg",
    tags: ["#ClimateAction", "#Community", "#Resilience"],
    href: "#climate-smart-agriculture-training",
  },
  {
    id: "protecting-marine-ecosystems",
    ...
    excerpt:
      "Our marine conservation initiatives are helping to restore coral reefs and protect marine life for generations to come.",
    image: "/images/marine.jpg",
    tags: ["#Sustainability", "#Resilience", "#SDGs"],
    href: "#protecting-marine-ecosystems",
  },
  {
    id: "youth-sustainable-action-summit",
    category: "GLOBAL GOALS",
    categoryId: "global-goals",
    badgeBg: "#f3e7f8",
    badgeColor: "#6e278f",
    date: "Jul 20, 2025",
    title: "Youth Lead the Way in Sustainable Action",
    excerpt:
      "Young leaders from across the region came together for a climate action summit to share ideas and drive change.",
    image: "/images/knowledge/youth-sdgs.jpg",
    tags: ["#SDGs", "#Community", "#ClimateAction"],
    href: "#youth-sustainable-action-summit",
  },
];
